<template>
  <div class="container">
    <div class="notification">
      <i></i>
      <p>2022 Sbit Project ANNOUCEMENTS</p>
    </div>
    ...
    <Panel title="Network Overview" width="100%" height="355px" icon="icon-global" noMargin="true">
      <div class="detail">
        ...
        <div class="info">
          <span class="title">Sbit Trasactions in the last 14 days</span>
          <div class="frame">
        ...
        <table class="deal-table">
          ...
          <tbody>
            <tr v-for="transaction in recentTransactions" :key="transaction.id">
              ...
              <td>{{ transaction.outputValue | sbit(4) }} MRX</td>
              <td>
