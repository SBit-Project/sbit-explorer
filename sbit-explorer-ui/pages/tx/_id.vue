        ...
        <div class="block-info-right list">
          <ul>
            <li>
              ...
              <div class="item-info">{{inputsValue | sbit(7)}} MRX</div>
            </li>
            <li>
              <div class="item-title">Output Value</div>
              <div class="item-info">{{outputsValue | sbit(7)}} MRX</div>
            </li>
            <li>
              <div class="item-title">Fee</div>
              <div class="item-info">{{fees | sbit(7)}} MRX</div>
            </li>
          </ul>
        </div>
      </div>
